...
/**
 * A sample implementation to submit an Update Subscriber API request.
 *
 * @author Yesmail
 * @version 1.0
 */
public class UpdateSubscriberRequest implements RequestInterface {
    private Map<String, String> subscriberMap;
    private String requestUri;
    private Method methodType;

	public UpdateSubscriberRequest (Map<String, String> subscriberMap) {
	...
	public String toXml() {
        ...
        sb.append("</yesws:attribute>");
        sb.append("<yesws:attribute>");
        sb.append("<yesws:name>string type</yesws:name>");
